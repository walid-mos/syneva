// Generates src/frontend/shared/ui/icon-data.ts by inlining SVGs from the Iconify API (https://icones.js.org).
...
writeFileSync(
	new URL('../src/frontend/shared/ui/icon-data.ts', import.meta.url),
	`${header}export const ICON_DATA: Record<string, { vb: string; body: string }> = ${JSON.stringify(out, null, JSON_INDENT)};\n`,
)
process.stdout.write('wrote src/frontend/shared/ui/icon-data.ts\n')
