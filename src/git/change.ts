...
export function changeStableKeyFromBlock(lines: DiffLine[]): string {
...
export function changeBlockContent(lines: DiffLine[]): string {
	return lines
...
function changeAnchor(block: DiffLine[]): ChangeAnchor {
